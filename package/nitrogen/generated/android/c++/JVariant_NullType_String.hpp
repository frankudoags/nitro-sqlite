...
namespace margelo::nitro::nitrosqlite {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrosqlite/Variant_NullType_String;";
  ...
  namespace JVariant_NullType_String_impl {
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrosqlite/Variant_NullType_String$First;";
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrosqlite/Variant_NullType_String$Second;";
