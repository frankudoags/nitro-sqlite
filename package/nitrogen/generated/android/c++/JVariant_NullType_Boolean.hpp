...
namespace margelo::nitro::nitrosqlite {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrosqlite/Variant_NullType_Boolean;";
  ...
  namespace JVariant_NullType_Boolean_impl {
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrosqlite/Variant_NullType_Boolean$First;";
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrosqlite/Variant_NullType_Boolean$Second;";
